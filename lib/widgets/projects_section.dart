  ...
  final List<Map<String, String>> projects = const [
    {
      ...
      "shortDescription": "An app that connects blood donors with patients in need across Pakistan.",
      "description":
      " Problem:\n"
...

    {
      ...
      "title": "Voting App",
      "shortDescription": "A smart mobile app designed to simplify daily task management and boost productivity.",
      "description":
      " Problem:\n"
...

    {
      ...
      "shortDescription": "A modern mobile app to track cryptocurrencies and get real-time updates.",
      "description":
      " Problem:\n"
